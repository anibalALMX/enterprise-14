...
class User(models.Model):
    ...
    def __init__(self, pool, cr):
        ...
        pool[self._name].SELF_READABLE_FIELDS = pool[self._name].SELF_READABLE_FIELDS + l10n_be_payroll_readable_fields
        pool[self._name].SELF_WRITEABLE_FIELDS = pool[self._name].SELF_WRITEABLE_FIELDS + l10n_be_payroll_readable_fields
        return init_res
